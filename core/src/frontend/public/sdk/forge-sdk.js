(() => {
  ...
  class ForgeBackendClient {
    ...
    async writeAuditLog(accessToken, action, severity, payload = {}) {
  ...
  if (typeof window !== "undefined") {
    window.ForgeClient = ForgeClient;
    window.ForgeBackendClient = ForgeBackendClient;
  }
})();
